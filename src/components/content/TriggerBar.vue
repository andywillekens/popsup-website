...
<template>
  <section
    class="flex flex-col lg:flex-row full-width justify-center items-center gap-10 xl:gap-20 mt-4 lg:mt-16 px-4 py-16 [mask-image:_linear-gradient(to_right,transparent_0,_purple_128px,_black_calc(100%-200px),transparent_100%)]">
    <div class="w-full inline-flex flex-nowrap group">
      <ul
        ...
        <li
          ...
          <Icon
            :name="trigger.icon"
            class="text-mirage-900 absolute -right-5 -bottom-20 opacity-5"
            size="175" />
        </li>
      </ul>
      <ul
