...
<template>
  <div
    v-if="!isTracking"
    id="cookieConsent"
    class="flex flex-col fixed left-4 sm:left-8 bottom-4 sm:bottom-8 right-4 z-50 bg-white self-start rounded-2xl shadow-xl shadow-mirage-900/20 border border-mirage-900/10 gap-4 max-w-80 -translate-x-[calc(100%_+_4rem)] animate-slide-in-from-left">
